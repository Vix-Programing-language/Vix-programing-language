...
struct Exprs {
    ...
    union {
        ...
        struct { LexerTokenTag op; Exprs* operand; SourceRange range; } unary_ops;
...
typedef struct { ParseError* data; size_t len, cap; } ParseErrorArr;
static ParseErrorArr g_errors;
